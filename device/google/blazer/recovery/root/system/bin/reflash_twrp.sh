...
# TODO_VERIFY: USB controller and UFS boot_devices addresses for deepspace platform
# On husky/zuma these were 11210000.dwc3 and 3c400000.ufs
echo androidboot.usbcontroller=11210000.dwc3 >> $folder/bootconfig
echo androidboot.boot_devices=3c400000.ufs >> $folder/bootconfig
